...
import { ADMIN_ADD_FUND_REPORT } from '@/adminstore/actions.type'
...
export default {
  data() {
        ...
        methods: {
            ...
            roiIncomeReport(){
                ...
                setTimeout(function(){
                    const table = $('#binary-income-report').DataTable({
                        ...
                        ajax: {
                            url: serveApiUserHost+'fund_report',
                            type: 'POST',
                            data: function (d) {
                                i = 0;
                                i = d.start + 1;
            ...
            exportToExcel(){
                var data = {frm_date: $('#frm_date').val(), to_date: $('#to_date').val(),id: $('#user_id').val(),action:'export',responseType: 'blob' };
                 this.$store
                .dispatch(ADMIN_ADD_FUND_REPORT, data)
                .then(resp => {
                    if(resp.code === 200){
