  ...
  <div class="content">
    <div class="">
      <div class="page-header-title">
        <h4 class="page-title">Stop Direct Income</h4>
      </div>
    </div>
...
import { BLOCK_DIRECT_INCOME,CHECKUSEREXISTED } from '@/adminstore/actions.type'
        ...
        if (result.value) {
            ...
            .then((resp) => {
              if (resp.code === 200) {
                ...
                this.$router.push({ name: "stop-direct-report-income" });
              } else {
