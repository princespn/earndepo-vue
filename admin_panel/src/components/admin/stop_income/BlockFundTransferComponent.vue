  ...
  <div class="content">
    <div class="">
      <div class="page-header-title">
        <h4 class="page-title">Block ROI Withdraw</h4>
      </div>
    </div>
...
import { BLOCK_FUND_TRANSFER,CHECKUSEREXISTED } from '@/adminstore/actions.type'
    ...
    stopDirectIncome() {
     ...
     new Swal({
        ...
        if (result.value) {
             ...
             this.$store
            .dispatch(BLOCK_FUND_TRANSFER, data)
            .then((resp) => {
              if (resp.code === 200) {
                this.$toast.success(resp.message);
               // this.stopDirectReport();
                 this.$router.push({ name: "block-roi-withdraw-report" });
              } else {
