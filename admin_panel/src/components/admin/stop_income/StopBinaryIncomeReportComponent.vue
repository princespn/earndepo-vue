            ...
            <div class="col-12">
                <div class="admin-card">
                    <div class="admin-card-header">
                        <h4 class="card-title">Stop Binary Income</h4>
                    </div>
...
<script>
 ...
 import { serveApiUserHost } from "../../../../admin_config.js";
    ...
    import $ from "jquery";
    import { BLOCK_BINARY_INCOME } from '@/adminstore/actions.type'
    ...
    export default {
        ...
        methods: {
            ...
            stopDirectReport(){
                ...
                setTimeout(function(){
                     that.table = $('#direct-income-report').DataTable({
                        ...
                        ajax: {
                            url: serveApiUserHost+'stop-binary-report',
                            type: 'POST',
                            data: function (d) {
                                i = 0;
                                i = d.start + 1;
                        ...
                        columns: [
                            ...
                            },
                            {
                                ...
                                render: function (data) {
                                    return `
                                            <label class="${(data.binary_income_status == 1)?'text-info':'text-warning'} waves-effect" id="changeStatus" data-id="${data.id}" data-status="${data.binary_income_status}">${(data.binary_income_status == 1)?'Unblock':'Unblock'}
                                            </label>`;
                                }
                            }
                        ]
            ...
            changeStatus(id, binary_income_status){
              ...
              new  Swal({
                    ...
                    if (result.value) {
                        var data= { id: id, binary_income_status: binary_income_status,};
                        this.$store
