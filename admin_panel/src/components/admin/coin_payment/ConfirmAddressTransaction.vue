        ...
        <div class="col-12">
          <div class="admin-card">
            <div class="admin-card-header">
              <h4 class="card-title">All Fund Report</h4>
            </div>
            <form id="searchForm">
              <div class="row">
                <div class="col-md-12">
...
export default {
  ...
  methods: {
    ...
    productReport() {
      ...
      setTimeout(function () {
        that.table = $("#deposit-address-transaction").DataTable({
          ...
          ajax: {
            url: serveApiUserHost + "getconfirmaddrtrans",
            type: "POST",
            data: function (d) {
              i = 0;
              i = d.start + 1;
    ...
    //   this.$store.dispatch(GET_CONFIRM_ADDTRANS, data).then((resp) => {
    //     if (resp.data.code === 200) {
    //       //this.export_url = resp.data.data.excel_url;
    //       var mystring = resp.data.data.data;
    //       var myblob = new Blob([mystring], {
