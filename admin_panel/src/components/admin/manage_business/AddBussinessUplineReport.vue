    ...
    <div class="container-fluid">
      <div class="admin-card">
        <div class="admin-card-header">
          <h4 class="card-title">Add Business Upline Report</h4>
        </div>
             <form id="searchForm">
          <div class="row">
            <div class="col-md-12">
          ...
          <div class="col-12">
            <div class="admin-card-body">
              <div class="table-responsive admin-table">
                  <table  v-once id="powerreport" class="table table-striped table-bordered dt-responsive">
                                        <thead>
                                            <tr>
                                                <th>Sr.No</th>                            
                                                <th>User Id</th>
                                                ...
                                                <th>Before Current Amount left Business</th>
                                                <th>Before Current Amount Right Business</th>
                                                <th>After Current Amount left Business</th>
                                                <th>After Current Amount Right Business</th>   
                                                <th>Remark</th>  
                                                <th>Status</th>           
                                                <th>Date</th>
            ...
            powerReport(){
                ...
                setTimeout(function(){
                    const table = $('#powerreport').DataTable({
                        ...
                        ajax: {
                            url: serveApiUserHost+'bussiness-upline-report',
                            type: 'POST',
                            data: function (d) {
                                i = 0;
                                i = d.start + 1;
