        ...
        <div class="col-6 mx-auto">
          <div class="admin-card">
            <div class="admin-card-header">
                  <h4 class="page-title">Add Business Upline</h4>
            </div>
                            ...
                            <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    <label for="power bv">Enter Business</label>
                                     <input type="text" class="admin-form-control" id="power_bv" name="power_bv" v-model="bussiness" placeholder="Enter Business Amount">
...
<script>
 ...
 import { ADD_BUSNIESS_UPLINE,CHECKUSEREXISTED,ADMIN_OTP} from "@/adminstore/actions.type";
...
export default {
    ...
    computed:{
            isCompleteForm(){
                return this.bussiness && this.type;
            },
          ...
          if(this.type == '')
            ...
            //this.username = '';
             ...
             var data = {
               ...
               this.$store
            .dispatch(ADD_BUSNIESS_UPLINE, data)
            .then(response=>{
                if(response.code == 200) {
                    this.$toast.success(response.message)
                    this.disablebtn = false;
                    this.$router.push({name: 'addbussiness-upline-report'});
                }else{
