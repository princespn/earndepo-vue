        ...
        <div class="col-12">
          <div class="admin-card">
            <div class="admin-card-header">
              <h4 class="card-title">Add Rank Power Report</h4>
            </div>
            <form id="searchForm">
              <div class="row">
                <div class="col-md-12">
...
export default {
  ...
  methods: {
       exportToExcel(){
                ...
                axios.post('rank_power_upline_report', params).then(resp => {
                    if(resp.data.code === 200){
                        ...
                        fileLink.setAttribute('download', 'AddRankpowerUpline_Report.xls');
    ...
    getLevelIncome() {
      ...
      setTimeout(function () {
        const table = $("#total-sell-report").DataTable({
          ...
          ajax: {
            url: serveApiUserHost + "rank_power_upline_report",
            type: "POST",
            data: function (d) {
              i = 0;
              i = d.start + 1;
