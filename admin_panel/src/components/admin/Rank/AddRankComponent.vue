  ...
  <div class="admin-content-body">
    <div class="container-fluid">
     ...
     <form id="addTopUp">
                    ...
                    <button type="button" class="btn btn-primary" @click="addTopUp" :disabled="!isComplete || !isDisabledBtn">Submit</button>
...
import { ADD_RANK,CHECKUSEREXISTED,ADMIN_OTP } from '@/adminstore/actions.type';
    ...
    addTopUp() {
      ...
      new Swal({
        ...
        if (result.value) {
             ...
             rank: this.topup.rank,otp:this.otp}; 
             this.$store
            .dispatch(ADD_RANK, data)
            .then((resp) => {
              if (resp.code === 200) {
                this.$toast.success(resp.message);
