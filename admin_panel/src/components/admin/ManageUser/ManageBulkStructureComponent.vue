        ...
        <div class="col-12">
          <div class="admin-card">
            <div class="admin-card-header">
              <h4 class="card-title">Manage Bulk Structure</h4>
            </div>
            <form id="searchForm">
              <div class="row">
                <div class="col-md-12">
    ...
    manageUserReport() {
      ...
      setTimeout(function () {
        const table = $("#manage-user-report").DataTable({
          ...
          ajax: {
            url: serveApiUserHost + "getBulkEntries",
            type: "POST",
            data: function (d) {
              i = 0;
              i = d.start + 1;
          ...
          columns: [
            ...
            },
            {
              render: function (data, type, row) {
                return `
                                            <a class="editmyProfile" data-id="${row.id}" data-status="${row.status}" title="Edit">
        ...
        $("#manage-user-report").on("click", ".editmyProfile", function () {
          if ($(this).data("status") == 0) {
            ...
            that.$toast.error(
              "Structure is already created,you can not edit this structure"
            );
          }
        });
