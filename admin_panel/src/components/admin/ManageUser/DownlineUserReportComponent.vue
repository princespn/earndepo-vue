        ...
        <div class="col-12">
          <div class="admin-card">
            <div class="admin-card-header">
              <h4 class="card-title">Downline Users Report</h4>
            </div>
            <form id="searchForm">
              <div class="row">
                <div class="col-md-12">
...
export default {
  ...
  methods: {
    exportToExcel() {
      ...
      axios.post("showDownlineUsers", params).then((resp) => {
    ...
    downlineUsersReport() {
      ...
      setTimeout(function () {
        const table = $("#downline-user-report").DataTable({
          ...
          ajax: {
            url: serveApiUserHost + "showDownlineUsers",
            type: "POST",
            data: function (d) {
              i = 0;
              i = d.start + 1;
          ...
          columns: [
            ...
            { data: "hash_unit" },
            {
              render: function (data) {
                return "<a href='" + data.status_url + "'>Checkout</a>";
              },
            },
            { data: "invoice_id" },
            { data: "payment_mode" },
