                                              ...
                                              <div class="col-md-12 d-flex justify-content-center plan-12">
                                                ...
                                                <div class="card-wraper-pl">
                                                  <div class="card card-plan">
                                                    <div class="card-body pd-0">
                                                     <label class="label-right bitcoin align-items-center">
                                                        <input type="radio" :checked="txttrade == '3'" name="txttrades" id="txttrades3" value="3" @change="getchangetype('3')">
                                                       <span class="card-before">
                                                          <div class="icon-wraper"><img src="user-assets/images/circle-chart.png" class="logo-img"></div>
                                                ...
                                                <div class="card-wraper-pl">
                                                  <div class="card card-plan">
                                                    <div class="card-body pd-0">
                                                     <label class="label-right bitcoin align-items-center">
                                                        <input type="radio" :checked="txttrade == '4'" name="txttrades"  id="txttrades4" value="4" @change="getchangetype('4')">
                                                       <span class="card-after">
                                                          <div class="icon-wraper"><img src="user-assets/images/circle-chart.png" class="logo-img"></div>
                                              ...
                                              <div class="col-md-12 d-flex justify-content-center plan-12">
                                                ...
                                                <div class="card-wraper-pl">
                                                  <div class="card card-plan">
                                                    <div class="card-body pd-0">
                                                     <label class="label-right bitcoin align-items-center">
                                                         <input type="radio" :checked="txtico == '5'" name="txticos" id="txticos5" value="5" @change="getchangetype('5')">
                                                       <span class="card-before">
                                                          <div class="icon-wraper"><img src="user-assets/images/chart-circle.png" class="logo-img"></div>
                                                ...
                                                <div class="card-wraper-pl">
                                                  <div class="card card-plan">
                                                    <div class="card-body pd-0">
                                                     <label class="label-right bitcoin align-items-center">
                                                         <input type="radio" :checked="txtico == '6'" name="txticos"  id="txticos6" value="6" @change="getchangetype('6')">
                                                       <span class="card-after">
                                                          <div class="icon-wraper"><img src="user-assets/images/circle-chart.png" class="logo-img"></div>
                                     ...
                                     <div class="login-wraper listing-container">
                                       <div class="row">
                                          ...
                                          <div class="col-md-6">
                                             <div class="qr-wraper">
                                                <div class="img-wraper">
                                                  <vue-qrcode v-bind:value="invoice.address" />
                                                </div>
